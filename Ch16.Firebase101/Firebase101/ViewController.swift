...
extension ViewController {
    func saveBasicTypes() {
        ...
        db.child("str").setValue("sting value - 여러분 안녕")
    ...
    func saveCustomers() {
        ...
        let customer1 = Customer(id: "\(Customer.id)", name: "Kibum", books: books)
        Customer.id += 1
        let customer2 = Customer(id: "\(Customer.id)", name: "Minho", books: books)
        Customer.id += 1
        let customer3 = Customer(id: "\(Customer.id)", name: "Onew", books: books)
        Customer.id += 1
